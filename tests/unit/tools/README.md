...
| Ficheiro | Descricao |
|---|---|
| `test_barriers.py` | Testa `subtask_list` e `search_result` — detecção de barriers pelo `BarrierAwareToolNode` |
...
- Barriers são detectadas pelo nome (`subtask_list`, `search_result`) e os seus args extraídos
